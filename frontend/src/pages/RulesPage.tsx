    ...
    <div className="max-w-2xl">
      ...
      <Section title="⏰ Plazos para pronosticar">
        <ul className="text-sm text-gray-400 space-y-2 list-disc list-inside">
          ...
          <li>La fase de grupos se divide en <span className="text-gray-200 font-medium">3 jornadas independientes</span>. Cada jornada tiene su propio plazo: se cierra <span className="text-gray-200 font-medium">1 hora antes del primer partido de esa jornada</span>. Puedes pronosticar la Jornada 2 aunque la Jornada 1 ya esté cerrada, y lo mismo para la Jornada 3.</li>
          <li>Las fases eliminatorias (Ronda de 32 en adelante) cierran <span className="text-gray-200 font-medium">1 hora antes del primer partido de esa fase</span> — todos sus partidos a la vez.</li>
